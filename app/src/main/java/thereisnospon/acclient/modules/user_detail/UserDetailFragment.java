...
public class UserDetailFragment extends Fragment implements UserDetailContact.View {
    ...
    TextView userRank;
    @BindView(R.id.user_submmit)
    TextView userSubmmit;
    @BindView(R.id.user_solved)
    TextView userSolved;
    @BindView(R.id.user_submmision)
    TextView userSubmmision;
    @BindView(R.id.user_ac)
    TextView userAc;
    ...
    public void onSuccess(UserInfo userInfo) {
        ...
        ProblemNodeAdapter adapter=new ProblemNodeAdapter(
