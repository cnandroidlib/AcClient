...
import thereisnospon.acclient.modules.login.LoginPresenter;
import thereisnospon.acclient.modules.login.RegisterActivity;
...
public class HelloActivity extends AppCompatActivity implements LoginContact.View{
    ...
    void initView(){
        ...
        if(loginButton!=null){
           loginButton.setOnClickListener(new View.OnClickListener() {
               @Override
               public void onClick(View v) {
                   HelloActivity.this.id =loginId.getText().toString();
                   HelloActivity.this.pass=loginPass.getText().toString();
                   Toast.makeText(HelloActivity.this,id+pass+"",Toast.LENGTH_SHORT).show();
